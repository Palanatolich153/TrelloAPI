...
public abstract class BaseAbstract {
    ...
    protected String createListEndpoint = "1/lists?idBoard=&idListSource=&key=" + key + "&token=" + token;
    protected String createCardEndpoint = "1/cards?name=";
    ...
    protected String getOpenListWelcomeToTrelloBoardFullEndpoint = getListsEndpoint + welcomeToTrelloBoardId +
