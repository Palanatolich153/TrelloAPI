...
public class APITests extends BaseClass {
    ...
    public void createListAndMapResponseToJsonObject() {
        ...
        JsonObject responseBody = services.executePostRequestAndReturnRequestBody(createListEndpoint, requestBody);
    ...
    public void createCard() {
        ...
        JsonObject listResponseBody = services.createList(createListEndpoint);

        String createCardFullEndpoint = createCardEndpoint + cardName + "&idList=" + helper.modifyString(listResponseBody.get("id"));

        JsonObject cardRequestBody = helper.createRequestBody(Constants.credentialTemplateFilePath);
        JsonObject cardResponseBody = services.executePostRequestAndReturnRequestBody(createCardFullEndpoint, cardRequestBody);
